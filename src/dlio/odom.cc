...
dlio::OdomNode::OdomNode()
  ...
  this->zmq_publish_timer =
      this->create_wall_timer(std::chrono::duration<double>(0.01),
                              std::bind(&dlio::OdomNode::zmqPublishPose, this));
  ...
  zmq_odom_publisher_.bind("tcp://127.0.0.1:5556");
}
...
void dlio::OdomNode::initializeInputTarget() {
  ...
  if (keyframes.size() > 3) {
    keyframes = {keyframes.end() - 5, keyframes.end()};
    keyframe_timestamps = {keyframe_timestamps.end() - 5,
                           keyframe_timestamps.end()};
    keyframe_normals = {keyframe_normals.end() - 5, keyframe_normals.end()};
    keyframe_transformations = {keyframe_transformations.end() - 5,
                                keyframe_transformations.end()};
  }
}
...
dlio::OdomNode::transformImu(const sensor_msgs::msg::Imu::SharedPtr &imu_raw) {
